...
[brPatient, ~, brAntibiotics, brAdmissions, brPFT, brCRP, ...
...
% Nbr of people on drug therapy pre vs during
% and remove those who started drug therapy in the first 6 months.
meastype = 'CFTRMod';
bestwind = 6;
period1  = 'Pre';
period2  = 'Dur';
