...
switch mltablename
    case 'acPatient'
        mltable = table('Size',[nrows 28], ...
                        'VariableTypes', {'double',          'cell',       'cell',          'cell',               'datetime',     'datetime',     'datetime',     'datetime', ...
                                          'datetime',        'datetime',   'double',        'cell',               'cell',         'double',       'double',  ...
                                          'double',          'double',     'cell',          'cell',               'cell',         'cell', ...
                                          'cell',            'double',     'double',        'double',             'double',       ...
                                          'double',          'double'}, ...
                        'VariableNames', {'ID',              'Hospital',   'StudyNumber',   'StudyNumber2',       'StudyDate',    'StudyEndDate', 'Prior6Mnth',   'Post6Mnth', ...
    ...
    case 'acEndStudy'
        mltable = table('Size',[nrows 6], ...
                        ...
                        'VariableNames', {'ID',     'Hospital', 'StudyNumber', 'EndOfStudyReason', 'EndOfStudyDate', 'Comments'});
