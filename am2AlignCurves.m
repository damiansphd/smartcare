...
for i = 1:ninterventions
    [meancurvesum, meancurvecount] = am2AddToMean(meancurvesum, meancurvecount, amNormcube, amInterventions, i, max_offset, align_wind, nmeasures);
end
...
ok  = 0;
while 1
    [meancurvesum, meancurvecount] = am2RemoveFromMean(meancurvesum, meancurvecount, amNormcube, amInterventions, pnt, max_offset, align_wind, nmeasures);
    %check safety
    ok = 1;
    ...
    if ok == 1
        [better_offset, hstg] = am2BestFit(meancurvesum, meancurvecount, amNormcube, amInterventions, hstg, pnt, max_offset, align_wind, nmeasures);
    else
    ...
    [meancurvesum, meancurvecount] = am2AddToMean(meancurvesum, meancurvecount, amNormcube, amInterventions, pnt, max_offset, align_wind, nmeasures);
...
for i=1:ninterventions
    [meancurvesum, meancurvecount] = am2RemoveFromMean(meancurvesum, meancurvecount, amNormcube, amInterventions, i, max_offset, align_wind, nmeasures);
    qual = qual + am2CalcObjFcn(meancurvesum, meancurvecount, amNormcube, amInterventions, hstg, i, amInterventions.Offset(i), max_offset, align_wind, nmeasures, 0);
    [meancurvesum, meancurvecount] = am2AddToMean(meancurvesum, meancurvecount, amNormcube, amInterventions, i, max_offset, align_wind, nmeasures);
end
