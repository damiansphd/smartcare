function [resultrow] = setResultTableDisplayRow(mversion, study, sigmamethod, mumethod, ...
    ...
    outprior, heldbackpct, confidencethreshold, countthreshold, nlatentcurves, niterations, scenario, ex_start, qual, ...
...
resultrow = table('Size',[1 27], ...
                 ...
                 'VariableNames', {'Version', 'Study', 'Sigma', 'Mu', 'CurveAvg', ...
                      ...
                      'DataSmooth', 'RunMode', 'RandomSeed', 'IntrMode', 'CountThresh', 'Scenario', ...
