function [resultrow] = setResultTableDisplayRow(mversion, study, treatgap, testlabelmthd, sigmamethod, mumethod, ...
    ...
    confidencethreshold, countthreshold, nlatentcurves, niterations, vshiftmode, scenario, ex_start, qual, ...
