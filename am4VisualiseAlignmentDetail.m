function [sorted_interventions, max_points] = am4VisualiseAlignmentDetail(amDatacube, amInterventions, offsets, profile_pre, profile_post, count_post, std_post, measures, max_offset, align_wind, nmeasures, run_type, study, ex_start, curveaveragingmethod)
