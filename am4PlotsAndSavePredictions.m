...
for m = 1:nmeasures
    ...
    [xl, yl] = plotLatentCurve(ax, max_offset, align_wind, offsets(thisinter), (meancurvemean(:, m) + normmean(thisinter, m)), xl, yl, 'red', ':', 1.0);
    [xl, yl] = plotLatentCurve(ax, max_offset, align_wind, offsets(thisinter), smooth(meancurvemean(:, m) + normmean(thisinter, m),5), xl, yl, 'red', '-', 1.0);
