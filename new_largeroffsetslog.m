...
[best_offsets best_profile best_histogram best_qual] = flexible_align(cubefin,intrfin,max_offset,align_wind, run_mode);
...
%    end
%    [offsets profile histogram qual] = flexible_align(cubefin,intrfin,max_offset,align_wind, run_mode);
%    if qual < best_qual
...
%for i = 38:41
        ...
        for k=1:4
            ...
            line( [max_offset-best_offsets(i) max_offset-best_offsets(i)] , [0 1],'Color','red', 'LineStyle',':','LineWidth',2);
            title(tit(k));
            xlim([1 max_offset]);
            ylim([0 1]);
        end
