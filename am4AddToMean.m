function [meancurvesumsq, meancurvesum, meancurvecount] = am4AddToMean(meancurvesumsq, meancurvesum, meancurvecount, ...
    amIntrCube, offset, currinter, min_offset, max_offset, align_wind, nmeasures)

% am4AddToMean - add an underlying curve to the meancurve (sumsq, sum and count) 
