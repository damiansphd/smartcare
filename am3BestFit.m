function [better_offset, hstg] = am3BestFit(meancurvesum, meancurvecount, meancurvestd, amDatacube, amInterventions, measures, normstd, hstg, currinter, max_offset, align_wind, nmeasures, sigmamethod)
...
for i = 0:max_offset - 1
    [currdist, hstg] = am3CalcObjFcn(meancurvesum, meancurvecount, meancurvestd, amDatacube, amInterventions, measures, ...
