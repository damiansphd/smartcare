function [datacube, normcube] = createDataCube(physdata, measures, demographicstable, overalltable, npatients, ndays, nmeasures)

% createDataCube - populates a 3D array from the measurement data of
% appropriate size
datacube = NaN(npatients, ndays, nmeasures);
normcube = NaN(npatients, ndays, nmeasures);
