...
plottitle   = sprintf('%s - %s S-Imp %s FPv3 Ex%s', plotname, run_type, shifttext, extext);
...
for i = 1:(ntitles + nlcrow + nmeasrows + nlabels)
    ...
    if type == 1 || type == 9 || type == 10
        ...
        if type == 1 || type == 10
            if nlatentcurves == 3
                annotation(sp(i), 'textbox',  ...
                                'String', {sprintf('%s 1', txt); sprintf('\\fontsize{%d} (n=%d)', unitfontsize, sum(amInterventions.LatentCurve == 1))}, ...
                                'Interpreter', 'tex', ...
                                'Units', 'normalized', ...
                ...
                annotation(sp(i), 'textbox',  ...
                                'String', {sprintf('%s 2', txt); sprintf('\\fontsize{%d} (n=%d)', unitfontsize, sum(amInterventions.LatentCurve == 2))}, ...
                                'Interpreter', 'tex', ...
                                'Units', 'normalized', ...
                                ...
                                'FontSize', labelfontsize);
                annotation(sp(i), 'textbox',  ...
                                'String', {sprintf('%s 3', txt); sprintf('\\fontsize{%d} (n=%d)', unitfontsize, sum(amInterventions.LatentCurve == 3))}, ...
                                'Interpreter', 'tex', ...
                                'Units', 'normalized', ...
