function [physdataout] = correctClimbDataAnomalies(physdata)
...
idx  = idx1 & idx2;
fprintf('Found %4d Lung Function measurements < 0.25l or > 4.0l\n', sum(idx));
physdata(idx,:)
...
idx  = idx1 & idx2;
fprintf('Found %4d O2 Saturation measurements < 70%% or > 100%%\n', sum(idx));
physdata(idx,:)
...
idx  = idx1 & idx2;
fprintf('Found %4d Pulse Rate measurements < 50 or > 200\n', sum(idx));
physdata(idx,:)
...
idx  = idx1 & idx2;
fprintf('Found %4d Respiratory Rate measurements < 10 or > 100\n', sum(idx));
physdata(idx,:)
...
idx  = idx1 & idx2;
fprintf('Found %4d Sleep Disturbance measurements > 35\n', sum(idx));
physdata(idx,:)
...
idx  = idx1 & idx2;
fprintf('Found %4d Temperature measurements < 30 or > 45\n', sum(idx));
physdata(idx,:)
