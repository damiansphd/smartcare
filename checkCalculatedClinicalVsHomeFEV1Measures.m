...
basedir = './';
subfolder = 'Plots';
filenameprefix = 'CalculatedClinicalVsHomeFEV1';
...
% uncomment to create plots just for patients with differences home vs
% clinical
...
% uncomment to create plots just for anomalous clinical FEV1 measures identified
