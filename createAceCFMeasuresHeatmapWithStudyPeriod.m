function createAceCFMeasuresHeatmapWithStudyPeriod(physdata, offset, cdPatient, study, filtfilesuffix)
...
% create the heatmap
title = sprintf('%s-Heatmap of Measures with Study Period-%s', study, filtfilesuffix);
...
% save results
basedir = setBaseDir();
filename = sprintf('%s-HeatmapAllPatientsWithStudyPeriod-%s', study, filtfilesuffix);
